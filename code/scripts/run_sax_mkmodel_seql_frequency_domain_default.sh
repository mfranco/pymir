...
#$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.A+  $MODEL_DIR/seql.model.bin.A+ > $RESULTS_DIR/results.A+
#sleep 5
###
###
###
...
#$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.B+  $MODEL_DIR/seql.model.bin.B+ > $RESULTS_DIR/results.B+
#sleep 5
###
###
###
...
#$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.C+  $MODEL_DIR/seql.model.bin.C+ > $RESULTS_DIR/results.C+
#sleep 5
###
###
###$SAX_CONVERT $TRAIN_DIR/train.C#+.txt -o $MODEL_DIR/sax.train.C#+.txt -I $TEST_DIR/test.C#+.txt -O $MODEL_DIR/sax.test.C#+.txt
...
#$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.D+  $MODEL_DIR/seql.model.bin.D+ > $RESULTS_DIR/results.D+
#sleep 5
###
###
###
...
##$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.E+  $MODEL_DIR/seql.model.bin.E+ > $RESULTS_DIR/results.E+
#sleep 5
##
...
##$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.F+  $MODEL_DIR/seql.model.bin.F+ > $RESULTS_DIR/results.F+
#sleep 5
##
##
###$SAX_CONVERT $TRAIN_DIR/train.F#+.txt -o $MODEL_DIR/sax.train.F#+.txt -I $TEST_DIR/test.F#+.txt -O $MODEL_DIR/sax.test.F#+.txt
...
$SEQL_CLASSIFIY $MODEL_DIR/seql.model.predictor.G+  $MODEL_DIR/seql.model.bin.G+ > $RESULTS_DIR/results.G+
#
#
#
#$SAX_CONVERT $TRAIN_DIR/train.G#+.txt -o $MODEL_DIR/sax.train.G#+.txt -I $TEST_DIR/test.G#+.txt -O $MODEL_DIR/sax.test.G#+.txt
